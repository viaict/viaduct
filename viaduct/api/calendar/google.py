...
service_email = ('913209651562-jorctggrfuanpqrc5hvmu0ep3rmg2tca'
...
def insert_event(title="", location="VIA kamer", start="", end="",
                 calendar_id=None):
...
def update_event(event_id, title="", location="VIA Kamer", start="", end="",
                 calendar_id=None):
    service = build_service()
