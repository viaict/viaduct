...
class CategoryAPI:
	...
	def update_categories_from_content(content, page):
		...
		* Unknown categories are created and save the path.
		...
		# obtain categories in which the page was previously present (used later on)
		...
		for match in matches:
			...
			# if the page was not yet included in the category we want to add it
		...
		absent_categories = filter(lambda x: x not in found_categories, previous_categories)
