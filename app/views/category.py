...
def category_page(cat=''):
    ...
    if is_root:
        ...
        # for categories we want all categories that do not have a super
        # category
    ...
    return render_template('category/view_category.htm', is_root=is_root,
                           current_category_name=cat, pages=pages,
